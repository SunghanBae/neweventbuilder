...
// Thu Jul 13 10:15:06 2017 by ROOT version 6.10/00
// from TTree tree/tree
// found on file: R1208_0_packed.root
//////////////////////////////////////////////////////////

#ifndef AIDA_packed_h
#define AIDA_packed_h
...
////#ifdef AIDA_packed_cxx
AIDA_packed::AIDA_packed(char* filename, TTree *tree) : fChain(0) 
{
...
AIDA_packed::~AIDA_packed()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t AIDA_packed::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AIDA_packed::LoadTree(Long64_t entry)
{
...
void AIDA_packed::Init(TTree *tree)
{
...
void AIDA_packed::Show(Long64_t entry)
{
...
Int_t AIDA_packed::Cut(Long64_t entry)
{
...
Long64_t AIDA_packed::GetEntriesFast()
{
  if(!fChain) return -1;
  return fChain->GetEntriesFast();
}
//#endif // #ifdef AIDA_packed_cxx
